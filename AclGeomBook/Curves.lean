...
Next in this library: divisors as finitely supported functions on
places, the degree homomorphism, Riemann–Roch spaces and Riemann's
inequality, and the genus — tracked on the curve-theory issue.
